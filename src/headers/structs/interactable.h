...
typedef enum {INTERACT_DEFAULT = 0, INTERACT_DOOR_FOREST_DUNGEON, INTERACT_CHEST, INTERACT_MIMIC, INTERACT_FISHING, INTERACT_SWITCH, INTERACT_SIGN, INTERACT_GATE} interactType;
